...
nnoremap <silent> <leader>ff :<C-u>Unite -smartcase -no-split -buffer-name=files  -start-insert buffer file_rec/async:! file_mru file/new<cr>
nnoremap <silent> <leader>fp :<C-u>Unite -smartcase -no-split -buffer-name=buffer -start-insert file_rec/git file/new<cr>
...
function! s:unite_my_settings()"{{{
  ...
  imap <buffer><silent> ii <Esc>
  imap <buffer><silent> jk <Esc>
